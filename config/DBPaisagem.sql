...
--Executing (default): 
SHOW INDEX FROM `Classificacoes` FROM `ages_paisagem`
--Executing (default): 
...
--Executing (default): 
SHOW INDEX FROM `Familias` FROM `ages_paisagem`
--Executing (default): 
...
--Executing (default): 
SHOW INDEX FROM `Especies` FROM `ages_paisagem`
--Executing (default): 
...
--Executing (default): 
SHOW INDEX FROM `nomesPopulares` FROM `ages_paisagem`
--Executing (default): 
...
--Executing (default): 
SHOW INDEX FROM `Users` FROM `ages_paisagem`